...
createRenderer("models/env_test.dae", "off", function(dae) {
  ...
  for (var i in scenes) {
    ...
    for (var j in c) {
      if (c[j].type == "Mesh") {
        ...
        var outlineMaterial = new THREE.MeshBasicMaterial( { color: 0x00FF00, side: THREE.BackSide, polygonOffset: true, polygonOffsetFactor: 0, polygonOffsetUnits: 0 } );
